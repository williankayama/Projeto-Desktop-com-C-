        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (idHospedePF != "" && idHospedePF != null)
                {
                    ...
                    String Query = "UPDATE Reserva SET idHospedePF = '" + idHospedePF +
                        "', telefone = '" + telefone +
                        "', checkIn = '" + dataCheckIn +
                        "', checkOut = '" + dataCheckOut +
                        "', numPessoas = '" + numPessoa +
                        "', numCriancas = '" + numCrianca +
                ...
                {
                    String strConexao = @"Data Source=BR-IT00230;Initial Catalog=ROYALPLAZA;Integrated Security=True";
                    String Query = "UPDATE Reserva SET idHospedePJ = '" + idHospedePJ +
                        "', telefone = '" + telefone +
                        "', checkIn = '" + dataCheckIn +
                        "', checkOut = '" + dataCheckOut +
                        "', numPessoas = '" + numPessoa +
